...
export default class PomMindBossRuin implements PomRuinCommon {
    seed: number;
    private readonly structure_area1 = "mystructure:boss_mind_area_b1";
    private readonly structure_area2 = "mystructure:boss_mind_area_b2";
    private readonly structure_area3 = "mystructure:boss_mind_area_b3";
    private readonly structure_area4 = "mystructure:boss_mind_area_b4";
    ...
    init(x: number, y: number, z: number, dim: Dimension): void {
        ...
        this._playerArea.push(
            new ExBlockArea(new Vector3(36, 37, 36).add(x, y, z), new Vector3(50, 4, 50))
        );
    }
    generate(): void {

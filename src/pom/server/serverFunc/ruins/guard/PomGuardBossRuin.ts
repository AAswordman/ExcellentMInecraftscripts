...
export default class PomGuardBossRuin implements PomRuinCommon {
    seed: number;
    private readonly structure_area1 = "mystructure:boss_guard_area_b1";
    private readonly structure_area2 = "mystructure:boss_guard_area_b3";
    private readonly structure_area3 = "mystructure:boss_guard_area_b2";
    private readonly structure_area4 = "mystructure:boss_guard_area_b4";

...
export default class RuinsLoaction {
    ...
    public static readonly GUARD_RUIN_NUM = 5;
    public static readonly GUARD_RUIN_LOCATION_START = new Vector3(16384, 64, 15360);
    public static readonly GUARD_RUIN_LOCATION_SIZE = new Vector3(128, 128, 128);
    public static readonly GUARD_RUIN_LOCATION_END = this.GUARD_RUIN_LOCATION_START.cpy().add(this.GUARD_RUIN_LOCATION_SIZE);
    public static readonly GUARD_RUIN_LOCATION_CENTER = this.GUARD_RUIN_LOCATION_START.cpy().add(this.GUARD_RUIN_LOCATION_SIZE.x / 2, 0, this.GUARD_RUIN_LOCATION_SIZE.z / 2);
    public static readonly GUARD_RUIN_AREA = new ExBlockArea(this.GUARD_RUIN_LOCATION_START, this.GUARD_RUIN_LOCATION_SIZE);
    public static readonly GUARD_RUIN_PROTECT_AREA = new ExBlockArea(
        this.GUARD_RUIN_LOCATION_START.cpy().sub(this.GUARD_RUIN_LOCATION_SIZE),
        this.GUARD_RUIN_LOCATION_END.cpy().add(this.GUARD_RUIN_LOCATION_SIZE), true);

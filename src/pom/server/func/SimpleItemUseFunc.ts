            ...
            if (item.typeId == "wb:power") {
                ...
                if (chapter == 0) {
                    switch (part) {
                        ...
                        case 0: {
                            if (!afterDragon) useDialog_plot.show(this.player, "wb_base_talk000");
                            if (afterDragon) useDialog_plot.show(this.player, "wb_base_talk0");
                            break;
                        }
                        case 1: {
                        ...
                        case 5: {
                            if (nearBoss) useDialog_plot.show(this.player, "wb_base_talk33");
                            if (!nearBoss) useDialog_plot.show(this.player, "wb_base_talk34");
                            break;
                        }
                        case 6: {
                        ...
                        case 9: {
                            if (nearBoss) useDialog_plot.show(this.player, "wb_base_talk57");
                            if (!nearBoss) useDialog_plot.show(this.player, "wb_base_talk58");
                            break;
                        }
                        case 10: {
                        ...
                        case 13: {
                            if (nearBoss) useDialog_plot.show(this.player, "wb_base_talk86");
                            if (!nearBoss) useDialog_plot.show(this.player, "wb_base_talk87");
                            break;
                        }
                        case 14: {
                        ...
                        case 16: {
                            if (nearBoss) useDialog_plot.show(this.player, "wb_base_talk101");
                            if (!nearBoss) useDialog_plot.show(this.player, "wb_base_talk102");
                            break;
                        }
                        case 17: {

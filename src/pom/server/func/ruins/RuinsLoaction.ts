...
export default class RuinsLoaction {
    ...
    public static readonly DESERT_RUIN_PROTECT_AREA = new ExBlockArea(
        this.DESERT_RUIN_LOCATION_START.clone().sub(this.DESERT_RUIN_LOCATION_SIZE),
        this.DESERT_RUIN_LOCATION_END.clone().add(this.DESERT_RUIN_LOCATION_SIZE));
    ...
    public static readonly STONE_RUIN_PROTECT_AREA = new ExBlockArea(
        this.STONE_RUIN_LOCATION_START.clone().sub(this.STONE_RUIN_LOCATION_SIZE),
        this.STONE_RUIN_LOCATION_END.clone().add(this.STONE_RUIN_LOCATION_SIZE));
    ...
    public static readonly CAVE_RUIN_LOCATION_END = this.CAVE_RUIN_LOCATION_START.clone().add(this.CAVE_RUIN_LOCATION_SIZE);
    public static readonly CAVE_RUIN_LOCATION_CENTER = this.CAVE_RUIN_LOCATION_START.clone().add(this.CAVE_RUIN_LOCATION_SIZE.x / 2, 0, this.CAVE_RUIN_LOCATION_SIZE.z / 2);

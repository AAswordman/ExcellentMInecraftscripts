...
export default class PomStoneBossRuin implements PomRuinCommon {
    ...
    init(x: number, y: number, z: number, dim: Dimension): void {
        ...
        this._playerArea.push(
            new ExBlockArea(new Vector3(6, 5, 6).add(x, y, z), new Vector3(10, 6, 10)),
            new ExBlockArea(new Vector3(128 - 6 - 10, 5, 6).add(x, y, z), new Vector3(10, 6, 10)),
            new ExBlockArea(new Vector3(6, 5, 128 - 6 - 10).add(x, y, z), new Vector3(10, 6, 10)),
            new ExBlockArea(new Vector3(128 - 6 - 10, 5, 128 - 6 - 10).add(x, y, z), new Vector3(10, 6, 10))
        );
    }
    generate(): void {

...
export default class ExStructureJigsaw {
    ...
    setStructurePlane(x: number, z: number, offsetX: number, offsetY: number, offsetZ: number, structureName: string, structureRot = 0, mirror: StructureMirrorAxis = StructureMirrorAxis.None
    ...
    setStructure(x: number, z: number, y: number, offsetX: number, offsetY: number, offsetZ: number, structureName: string, structureRot = 0, mirror: StructureMirrorAxis = StructureMirrorAxis.None,
    ...
    fillStructure(offsetX: number, offsetY: number, offsetZ: number, structureName: string, structureRot = 0, mirror: StructureMirrorAxis = StructureMirrorAxis.None,
        coverGridLength = 1, coverGridWidth = 1, coverGridHeight = 1) {
